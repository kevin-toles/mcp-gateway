...
from src.models.schemas import (
    ...
    SADeadCodeInput,
    SADriftInput,
    SAExtractArchitectureInput,
    SAFitnessEvalInput,
    SAGetFitnessFunctionsInput,
    SAMappingLogInput,
    SAPlatformScanInput,
    SearchInInput,
    SemanticSearchInput,
    USSEmbedInput,
    USSFitnessBatchInput,
    USSFitnessEvaluateInput,
    USSGraphQueryInput,
    USSGraphTraverseInput,
    USSHydrateInput,
    USSRingSearchInput,
...
_INPUT_MODELS: dict[str, type[BaseModel]] = {
    ...
    "sa_detect_patterns": SAAnalysisInput,
    "sa_detect_boundaries": SAAnalysisInput,
    "sa_detect_events": SAAnalysisInput,
    "sa_detect_messaging": SAAnalysisInput,
    "sa_build_call_graph": SACallGraphInput,
    "sa_detect_dead_code": SADeadCodeInput,
    "sa_extract_architecture": SAExtractArchitectureInput,
    "sa_detect_drift": SADriftInput,
    "sa_architecture_mapping_log": SAMappingLogInput,
    "sa_platform_scan": SAPlatformScanInput,
    "sa_batch_scan": SABatchScanInput,
    "sa_evaluate_fitness": SAFitnessEvalInput,
    "sa_get_fitness_functions": SAGetFitnessFunctionsInput,
    # Context Management Service (CMS :8086)
    "cms_warmup": CMSWarmupInput,
    "cms_validate": CMSValidateInput,
    "cms_chunk": CMSChunkInput,
    "cms_optimize": CMSOptimizeInput,
    "cms_process": CMSProcessInput,
    "cms_get_metrics": CMSGetMetricsInput,
    "cms_glossary_define": CMSGlossaryDefineInput,
    "cms_get_glossary": CMSGetGlossaryInput,
    # Unified-Search-RS (Rust :8089) — uss_* pending tools
    "uss_ring_search": USSRingSearchInput,
    "uss_scientific_search": USSScientificSearchInput,
    "uss_embed": USSEmbedInput,
    "uss_hydrate": USSHydrateInput,
    "uss_fitness_evaluate": USSFitnessEvaluateInput,
